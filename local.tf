locals {
  ...
  workers_group_defaults_defaults = {
    ...
    spot_allocation_strategy                 = "capacity-optimized" # The only valid value is lowest-price, which is also the default value. The Auto Scaling group selects the cheapest Spot pools and evenly allocates your Spot capacity across the number of Spot pools that you specify.
